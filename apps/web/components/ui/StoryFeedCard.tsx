      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
          <ActionPill
            ...
            layout="horizontal"
            onLike={() =>
              likeMutation.mutate({ storyId: story.id, currentlyLiked: story.userHasLiked })
            }
            onSave={() =>
              saveMutation.mutate({ storyId: story.id, currentlySaved: story.userHasSaved })
            }
          />
        ...
        <span style={{ fontSize: 11, color: '#6b7280', fontStyle: 'italic' }}>
          {story.isAnonymous || !story.authorAlias ? 'BlushBite Stories' : story.authorAlias}
        </span>
      </div>
    </div>
  )
