  ...
  return (
    <div
      style={{
        ...
        borderRadius: 14,
        overflow: 'hidden',
        background: data.banner_image_url ? 'transparent' : 'linear-gradient(135deg,#1a1228,#2a1535)',
        border: '1px solid rgba(232,96,122,0.2)',
        marginBottom: 24,
        display: 'flex',
        alignItems: 'center',
    ...
    >
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        ...
        >
          ...
          {data.banner_headline ? '' : <em style={{ color: '#e8607a', fontStyle: 'italic' }}> awaits.</em>}
        </div>
