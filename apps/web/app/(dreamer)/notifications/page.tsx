...
function SkeletonRow() {
  return (
    <div
      style={{ display: 'flex', alignItems: 'center', gap: 12, padding: '14px 20px', height: 64 }}
    >
      <div
        className="shimmer"
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <p style={{ fontSize: 14, color: '#eeeef0', lineHeight: 1.4, marginBottom: 3 }}>
          ...
          {!['story_like', 'story_save', 'story_comment', 'comment_reply', 'comment_like'].includes(
            n.type
          ) && (
            <>
      ...
      {!n.is_read && (
        <span
          style={{ width: 8, height: 8, borderRadius: '50%', background: '#e8607a', flexShrink: 0 }}
        />
      )}
    </motion.button>
  )
...
function PermissionBanner({ onGranted }: { onGranted: () => void }) {
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <p style={{ fontSize: 13, color: '#eeeef0', fontWeight: 500, marginBottom: 1 }}>
        ...
        >
          ...
          >
            <div>
              ...
              {unreadCount > 0 && (
                <p style={{ fontSize: 12, color: '#6b7280', marginTop: 2 }}>{unreadCount} unread</p>
              )}
            </div>
            {unreadCount > 0 && (
              <button
                ...
                style={{
                  ...
                  background:
                    markedLabel === 'Marked ✓' ? 'rgba(74,222,128,0.08)' : 'rgba(232,96,122,0.08)',
          ...
          <PermissionBanner
            onGranted={() => setHeaderH(headerRef.current?.offsetHeight ?? headerH)}
          />
        </div>
        ...
        <div style={{ paddingTop: headerH > 0 ? headerH : undefined }}>
          ...
          {!isLoading && notifications.length === 0 && (
            ...
            >
              ...
              <p style={{ fontSize: 15, color: '#eeeef0', marginBottom: 10 }}>
